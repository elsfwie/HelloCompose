...
fun RegistrasiScreen() {
    ...
    //
    val isFormValid by rememberSaveable {
    ...
    Column(
        ...
        val state_context = androidx.compose.ui.platform.LocalContext.current
        Button(
            onClick  = {
                android.widget.Toast.makeText(state_context, "Registrasi berhasil dilakukan atas nama ${nama}", android.widget.Toast.LENGTH_SHORT).show()
                nama = ""
                email = ""
                password = ""
                konfirmasiPassword = ""
